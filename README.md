...
|-------------------|----------------|-------------|
| Казаков Данила    | [@KazDanila](https://t.me/KazDanila) | • Анализ данных<br>• Тестирование<br>• Написание документации для разработчиков|
| Величко Елизавета | [@lizzeeerr](https://t.me/lizzeeerr)   | • Разработка ядра бота<br>• Деплой приложения |
| Пашинов Артём     | [@amstr](https://t.me/amstr) | • Интеграция с API Binance<br>• Тестирование<br>• Написание документации для пользователей|
