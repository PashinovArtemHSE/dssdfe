...
|-------------------|----------------|-------------|
| Казаков Данила    | [@dfdfd](https://t.me/dfdfd) | • Анализ данных<<br>• Интеграция с API Binance<br>• Написание документации для разработчиков|
| Величко Елизавета | [@dfdf](https://t.me/dfdf)   | • Разработка ядра бота<br>• Деплой приложения |
| Пашинов Артём     | [@sdfsdf](https://t.me/sdfsdf) | • Анализ данных<<br>• Интеграция с API Binancе<br>• Написание документации для пользователя|
