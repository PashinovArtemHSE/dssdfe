...
|-------------------|----------------|-------------|
| Казаков Данила    | [@amstr](https://t.me/amstr) | • Анализ данных<br>• Тестирование<br>• Написание документации для разработчиков|
| Величко Елизавета | [@KazDanila](https://t.me/KazDanila)   | • Разработка ядра бота<br>• Деплой приложения |
| Пашинов Артём     | [@lizzeeerr](https://t.me/lizzeeerr) | • Интеграция с API Binance<br>• Тестирование<br>• Написание документации для пользователей|
