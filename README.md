...
|-------------------|----------------|-------------|
| Казаков Данила    | [@dfdfd](https://t.me/dfdfd) | • Разработка ядра бота<br>• Публикация и деплой<br>• Интеграция с API Binance |
| Величко Елизавета | [@dfdf](https://t.me/dfdf)   | • Анализ рыночных данных<br>• Тестирование функционала<br>• Создание руководства разработчика |
| Пашинов Артём     | [@sdfsdf](https://t.me/sdfsdf) | • Валидация данных<br>• Юзер-тестирование<br>• Написание пользовательской документации |
